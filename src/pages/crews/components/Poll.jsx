...
const polls = [
    {
        id: 1,
        question: "How we proceed tonigh?",
        type: "active",
        options: [
            { id: "a", label: "Doggy Style", votes: null },
            { id: "b", label: "You will ride me", votes: null },
            { id: "c", label: "Missionary from the back", votes: null },
        ],
    },
...
export default function PollsPage() {
    ...
    const handleCreatePoll = () => {
      ...
      try{
        // Aquí iría la lógica para enviar la nueva encuesta al backend, usando crewId para asociarla a la crew
        const response = await fetch(`/api/crews/${crewId}/polls`, {
            method: "POST",
